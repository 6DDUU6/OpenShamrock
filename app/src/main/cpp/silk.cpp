...
Java_moe_qiufuluo_shamrock_utils_AudioUtils_pcmToSilk(JNIEnv *env, jobject thiz,
                                             jint rate,
                                             jbyte type,
                                             jstring pcm_file,
                                             jstring silk_file) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_moe_qiufuluo_shamrock_utils_AudioUtils_silkToPcm(JNIEnv *env, jobject thiz, jint rate, jbyte type,
