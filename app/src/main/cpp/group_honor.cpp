...
Java_moe_qiufuluo_shamrock_remote_action_handlers_GetTroopHonor_nativeDecodeHonor(JNIEnv *env, jobject thiz,
                                                                         jstring user_id,
                                                                         jint honor_id,
                                                                         jbyte honor_flag) {
...
jobject make_honor_object(JNIEnv *env, jobject user_id, const Honor& honor) {
    jclass GroupMemberHonor = env->FindClass("moe/qiufuluo/shamrock/remote/service/data/GroupMemberHonor");
