...
Java_moe_qiufuluo_shamrock_helper_MessageHelper_createMessageUniseq(JNIEnv *env, jobject thiz,
                                                               jint chat_type,
                                                               jlong time) {
...
Java_moe_qiufuluo_shamrock_helper_MessageHelper_getChatType(JNIEnv *env, jobject thiz,
                                                       jlong msg_id) {
...
Java_moe_qiufuluo_shamrock_helper_MessageHelper_nativeDecodeCQCode(JNIEnv *env, jobject thiz,
                                                              jstring code) {
...
Java_moe_qiufuluo_shamrock_helper_MessageHelper_nativeEncodeCQCode(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_moe_qiufuluo_shamrock_helper_MessageHelper_insertChatTypeToMsgId(JNIEnv *env, jobject thiz,
