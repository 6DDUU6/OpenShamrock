package moe.qiufuluo.shamrock.ui.service.internal
...
import moe.qiufuluo.shamrock.ui.service.ModuleTalker
import moe.qiufuluo.shamrock.ui.service.handlers.*
...
inline fun Context.broadcastToModule(intentBuilder: Intent.() -> Unit) {
    val intent = Intent()
    intent.action = "moe.qiufuluo.xqbot.dynamic"
